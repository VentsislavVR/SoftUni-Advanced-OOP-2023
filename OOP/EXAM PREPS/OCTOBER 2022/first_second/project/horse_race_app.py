...
class HorseRaceApp:
    ...
    def create_horse_race(self, race_type: str):
        if race_type in [rt.race_type for rt in self.horse_races]:
    ...
    def start_horse_race(self, race_type: str):
        ...
        return f"The winner of the {race_type} race, with a speed of {highest_speed}km/h is {winner}! Winner's horse: {winner.horse.name}."
