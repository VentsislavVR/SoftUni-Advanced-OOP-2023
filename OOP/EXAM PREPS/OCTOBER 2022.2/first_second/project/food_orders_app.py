...
class FoodOrdersApp:
    ...
    def finish_order(self, client_phone_number: str):
        ...
        cur_bill = cur_client.bill
        cur_client.bill = 0.0
        return f"Receipt #{self.receipt_id} with total amount of {cur_bill:.2f} was successfully paid for {client_phone_number}."
