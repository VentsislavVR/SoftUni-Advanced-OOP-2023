...
class TestStudent(TestCase):
    def setUp(self) -> None:
        self.student = Student("TestGuy1", courses=None)
    ...
    def test_enroll_and_add_notes_to_existing_course(self):
        result = self.student_with_course.enroll("math", ["math is kind of fun", "just geometry thou"])
        self.assertEqual(["some note", "math is kind of fun",
                          "just geometry thou"]
    ...
    def test_enroll_and_add_notes_with_third_param_Y(self):
    ...
    def test_add_note_to_non_existing_course_raises_exception(self):
